                        ...
                        <form action="{{ route('kelas.update', ['id' => $kelas->id]) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="namaKelas" value="{{$kelas->namaKelas}}" class="form-control" id="exampleInputPassword1"
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="waliKelas" class="form-control select2" style="width: 100%;">
                                        @foreach ($guru as $guruItem)
                                            <option value="{{ $guruItem->nama }}" {{ $kelas->waliKelas === $guruItem->nama ? 'selected' : '' }}>
                                                {{ $guruItem->nama }}
                                            </option>
                                        @endforeach
                                    </select>
