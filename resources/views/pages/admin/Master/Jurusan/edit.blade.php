                        ...
                        <form action="{{ route('jurusan.update', ['id' => $jurusan->id]) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="kode" value="{{$jurusan->kode}}" class="form-control" id="exampleInputPassword1"
                                        placeholder="Nama Kelas" required>
                                </div>
                                <div class="form-group">
                                    <label>Nama Jurusan</label>
                                    <input type="text" name="namaJurusan" value="{{$jurusan->namaJurusan}}" class="form-control" id="exampleInputPassword1"
                                        placeholder="Nama Kelas" required>
                                </div>
